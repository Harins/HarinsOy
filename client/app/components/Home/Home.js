...
class Home extends Component {
  ...
  validateForm() {
    return this.state.signInError.length > 0 && this.state.signInPassword.length > 0;
  }
      ...
      return (
        <div>
          ...
          <div>
            ...
            <input type="email" placeholder="Email Address" value={signUpEmail} onChange={this.onTextboxChangeSignUpEmail} /><br />
